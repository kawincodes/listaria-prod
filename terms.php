...
if (!$text) {
    $text = "Terms of Service content not available.";
}

// Simple Parser for Professional Formatting
function parseLegalDoc($text) {
    ...
    foreach ($lines as $line) {
        ...
        // Regular Text
            ...
            elseif (stripos($line, 'Terms') !== false && strlen($line) < 50) {
...
<style>
    ...
    @media (max-width: 1024px) {
        ...
        .legal-sidebar {
            display: none; /* Hide sidebar on small screens for cleaner text focus */
        }
        .legal-paper {
            padding: 2.5rem;
        }
