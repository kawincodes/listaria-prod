                                        ...
                                        @foreach($languages as $key => $language)
                                            <div class="col-md-12 mb-4 border p-3 rounded shadow-sm">
                                                ...
                                                <div class="form-group">
                                                    <label for="translations_{{$language->id}}_description" class="form-label">
                                                        {{ __("Description") }}
                                                    </label>
                                                    <textarea class="form-control"
                                                            ...
                                                            rows="3"
                                                            placeholder="{{ __('Description in') . ' ' . $language->name }}"></textarea>
                                                </div>
                                            </div>
                                        @endforeach
                                @endif
                                ...
                                @if($languages->isNotEmpty())
                                        ...
                                        @foreach($languages as $language)
                                            <div class="col-md-12 mb-4 border p-3 rounded shadow-sm">
                                                ...
                                                <div class="form-group mb-3">
                                                    <label for="edit_translations_{{$language->id}}_name" class="form-label">
                                                        {{ __("Name") }}
                                                    </label>
                                                    <input type="text" class="form-control"
                                                        id="edit_translations_{{$language->id}}_name"
                                                        name="translations[{{$language->id}}][name]"
                                                        placeholder="{{ __('Name in') . ' ' . $language->name }}"
                                                        value="">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="edit_translations_{{$language->id}}_description" class="form-label">
                                                        {{ __("Description") }}
                                                    </label>
                                                    <textarea class="form-control"
                                                        id="edit_translations_{{$language->id}}_description"
                                                        name="translations[{{$language->id}}][description]"
                                                        rows="3"
                                                        placeholder="{{ __('Description in') . ' ' . $language->name }}"></textarea>
                                                </div>
