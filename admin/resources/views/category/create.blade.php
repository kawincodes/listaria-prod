                                ...
                                <div class="row">
                                    ...
                                    @foreach($languages as $key => $language)
                                        <div class="col-md-6 form-group">
                                            <label for="name_{{$language->id}}" class="form-label">{{ ($key + 1) . ". " . $language->name }} {{ __('Name') }}:</label>
                                            <input name="translations[{{$language->id}}][name]" id="name_{{$language->id}}" class="form-control" value="">
                                            <label for="description_{{$language->id}}" class="mandatory form-label">{{  $language->name }} {{ __('Description') }}</label>
                                            <textarea name="translations[{{$language->id}}][description]" id="description_{{$language->id}}" class="form-control" cols="10" rows="5"></textarea>
                                        </div>
                                    @endforeach
                                </div>
                                @endif
