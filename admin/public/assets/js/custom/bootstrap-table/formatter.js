...
function subCategoryFormatter(value, row) { 
     const subcategoriesLabel = "{{ __('Custom Fields') }}";
...
function customFieldFormatter(value, row) {
      const customFieldsLabel = "{{ __('Custom Fields') }}";
    ...
    if (textContent.length > 100) {
        ...
        return `
            <div class="short-description">
                ${shortText}...
                <a href="#" class="view-more" data-index="${index}">View More</a>
            </div>
            <div class="full-description" style="display:none;">
                ${value}
                <a href="#" class="view-more" data-index="${index}">View Less</a>
            </div>
        `;
    } else {
        return value;
